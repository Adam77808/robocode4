...
<head>
    ...
    <title>🤖 Univers des Robots - 5 Mini-Jeux</title>
    <style>
...
<body>
    ...
    <div class="container">
        ...
        <div class="games-grid">
            <div class="game-card" onclick="openGame('game1')">
                ...
                <h2>Émotions</h2>
                <p>Programme les réactions émotionnelles de ton robot face aux situations</p>
            ...
            <div class="game-card" onclick="openGame('game2')">
                <div class="game-icon">🎵</div>
                <h2>Musical</h2>
                <p>Compose des mélodies en assemblant les modules sonores de ton robot</p>
                <button class="play-btn">Lancer</button>
            </div>
            ...
            <div class="game-card" onclick="openGame('game3')">
                <div class="game-icon">🪞</div>
                <h2>Miroir</h2>
                <p>Synchronise deux robots en créant des séquences inversées</p>
                <button class="play-btn">Lancer</button>
            </div>
            ...
            <div class="game-card" onclick="openGame('game4')">
                <div class="game-icon">📖</div>
                <h2>Aventure</h2>
                <p>Explore une planète inconnue et programme ton robot à chaque décision</p>
                <button class="play-btn">Lancer</button>
            </div>
            ...
            <div class="game-card" onclick="openGame('game5')">
                <div class="game-icon">🐛</div>
                <h2>Bugs</h2>
                <p>Crée des dysfonctionnements amusants et observe les comportements chaotiques</p>
                <button class="play-btn">Lancer</button>
            </div>
        </div>
    </div>
    ...
    <div id="game1" class="modal">
        <div class="modal-content">
            ...
            <h2>ROBOT ÉMOTIONS</h2>
            <p>Trouve la bonne émotion avant la fin du temps ! 🎯</p>
            ...
            <div style="display: flex; justify-content: space-around; margin-bottom: 30px;">
                ...
                <div style="text-align: center;">
                    ...
                    <div id="emotionCombo" style="font-size: 3em; color: #00ff88; font-family: 'Orbitron', sans-serif;">×1</div>
                </div>
                <div style="text-align: center;">
            ...
            <div class="robot-display" id="emotionRobot">🤖</div>
            
            <div class="situation-box">
                <strong>SITUATION :</strong><br>
                <span id="currentSituation">Clique sur DÉMARRER pour commencer !</span>
            </div>
            
            <div class="emotion-buttons">
                <button class="emotion-btn" onclick="checkEmotion('😊', 'content')" disabled>😊 Content</button>
                <button class="emotion-btn" onclick="checkEmotion('😢', 'triste')" disabled>😢 Triste</button>
                <button class="emotion-btn" onclick="checkEmotion('😮', 'surpris')" disabled>😮 Surpris</button>
                <button class="emotion-btn" onclick="checkEmotion('😡', 'colère')" disabled>😡 Colère</button>
                <button class="emotion-btn" onclick="checkEmotion('😴', 'fatigué')" disabled>😴 Fatigué</button>
                <button class="emotion-btn" onclick="checkEmotion('🤔', 'pensif')" disabled>🤔 Pensif</button>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px;">
                <button class="play-btn" id="emotionStartBtn" onclick="startEmotionGame()">DÉMARRER</button>
            </div>
        </div>
    </div>
    ...
    <div id="game2" class="modal">
        <div class="modal-content">
            ...
            <h2>ROBOT MUSICAL</h2>
            <p>Mémorise et reproduis la séquence du robot ! 🎼</p>
            ...
            <div id="musicStatus" style="text-align: center; font-size: 1.5em; color: #00f5ff; margin-bottom: 20px; min-height: 40px;">
                Clique sur DÉMARRER pour commencer !
            </div>
            
            <div class="robot-parts">
                <div class="part" id="part-head" onclick="playerPlayNote('🎤', 'Do')">
                    <div class="part-icon">🎤</div>
                    <div class="part-label">Module Vocal (Do)</div>
                </div>
                <div class="part" id="part-body" onclick="playerPlayNote('📦', 'Mi')">
                    <div class="part-icon">📦</div>
                    <div class="part-label">Corps Central (Mi)</div>
                </div>
                <div class="part" id="part-arm" onclick="playerPlayNote('🦾', 'Sol')">
                    <div class="part-icon">🦾</div>
                    <div class="part-label">Bras Mécanique (Sol)</div>
                </div>
                <div class="part" id="part-leg" onclick="playerPlayNote('🦿', 'La')">
                    <div class="part-icon">🦿</div>
                    <div class="part-label">Jambes Servo (La)</div>
                </div>
            </div>
            
            <div class="sequence-display" id="musicSequence">● ● ●</div>
            
            <div class="control-buttons">
                <button class="control-btn play-sound" id="musicStartBtn" onclick="startMusicGame()">DÉMARRER</button>
                <button class="control-btn clear" id="musicReplayBtn" onclick="replaySequence()" style="display: none;">🔊 Réécouter</button>
            </div>
        </div>
    </div>
    ...
    <div id="game3" class="modal">
        <div class="modal-content">
            ...
            <div class="mirror-container">
                <div class="robot-box">
                    ...
                    <div class="arrow-buttons">
                        <div></div>
                        <button class="arrow-btn" onclick="addMove(1, '⬆️')">⬆️</button>
                        <div></div>
                        <button class="arrow-btn" onclick="addMove(1, '⬅️')">⬅️</button>
                        <div></div>
                        <button class="arrow-btn" onclick="addMove(1, '➡️')">➡️</button>
                ...
                <div class="robot-box">
                    ...
                    <div class="arrow-buttons">
                        <div></div>
                        <button class="arrow-btn" onclick="addMove(2, '⬆️')">⬆️</button>
                        <div></div>
                        <button class="arrow-btn" onclick="addMove(2, '⬅️')">⬅️</button>
                        <div></div>
                        <button class="arrow-btn" onclick="addMove(2, '➡️')">➡️</button>
            ...
            <div style="text-align: center;">
                <button class="play-btn" onclick="checkMirror()">Vérifier</button>
    ...
    <div id="game5" class="modal">
        <div class="modal-content">
            ...
            <h2>LABORATOIRE DE RÉPARATION</h2>
            <p>Diagnostique le bug et répare le robot avant qu'il soit trop tard ! ⚠️</p>
            ...
            <div class="bug-playground">
                <div class="bug-robot" id="bugRobot">🤖</div>
                <div class="bug-status" id="bugStatus">Clique sur DÉMARRER pour commencer !</div>
                
                <div class="bug-controls">
                    <button class="bug-btn" id="fix-spin" onclick="attemptFix('spin')">🔧 Réparer Rotation</button>
                    <button class="bug-btn" id="fix-bounce" onclick="attemptFix('bounce')">🔧 Réparer Rebond</button>
                    <button class="bug-btn" id="fix-grow" onclick="attemptFix('grow')">🔧 Réparer Taille</button>
                    <button class="bug-btn" id="fix-shake" onclick="attemptFix('shake')">🔧 Réparer Vibration</button>
                    <button class="bug-btn" id="fix-rainbow" onclick="attemptFix('rainbow')">🔧 Réparer Couleur</button>
                    <button class="bug-btn" id="fix-flip" onclick="attemptFix('flip')">🔧 Réparer Flip</button>
                </div>
                
                <button class="play-btn" id="repairStartBtn" onclick="startRepairGame()" style="margin-top: 30px;">DÉMARRER</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const emotionSituations = [
            {text: "Le robot rencontre un ami qu'il n'a pas vu depuis longtemps", correct: 'content', emoji: '😊'},
            {text: "Le robot perd ses données importantes", correct: 'triste', emoji: '😢'},
            {text: "Une météorite s'écrase juste devant le robot", correct: 'surpris', emoji: '😮'},
            {text: "Un autre robot vole l'invention du robot", correct: 'colère', emoji: '😡'},
            {text: "Le robot travaille depuis 48 heures sans recharge", correct: 'fatigué', emoji: '😴'},
            {text: "Le robot doit résoudre une équation complexe", correct: 'pensif', emoji: '🤔'},
            {text: "Le robot trouve un trésor caché", correct: 'content', emoji: '😊'},
            {text: "Le robot voit son ami partir en mission lointaine", correct: 'triste', emoji: '😢'},
            {text: "Un portail dimensionnel s'ouvre devant le robot", correct: 'surpris', emoji: '😮'},
            {text: "Le robot découvre qu'on l'a saboté", correct: 'colère', emoji: '😡'},
            {text: "Le robot vient de finir une mission de 72 heures", correct: 'fatigué', emoji: '😴'},
            {text: "Le robot doit choisir entre deux missions importantes", correct: 'pensif', emoji: '🤔'},
            {text: "Le robot réussit sa mission impossible", correct: 'content', emoji: '😊'},
            {text: "Le robot casse son outil préféré", correct: 'triste', emoji: '😢'},
            {text: "Le robot découvre une nouvelle forme de vie", correct: 'surpris', emoji: '😮'},
            {text: "Le robot est accusé injustement", correct: 'colère', emoji: '😡'},
            {text: "Le robot a exploré 10 planètes sans pause", correct: 'fatigué', emoji: '😴'},
            {text: "Le robot doit décider du futur de la colonie", correct: 'pensif', emoji: '🤔'}
        ];
        ...
        function startEmotionGame() {
            ...
            document.getElementById('emotionCombo').textContent = '×1';
        ...
        function nextEmotionSituation() {
            ...
            document.getElementById('emotionRobot').innerHTML = '🤖';
            document.getElementById('emotionFeedback').textContent = '';
        ...
        function correctAnswer(emoji) {
            ...
            document.getElementById('emotionCombo').textContent = '×' + emotionCombo;
        ...
        function wrongAnswer() {
            ...
            robot.innerHTML = `<div style="font-size: 1em;">❌</div>`;
            feedback.innerHTML = `❌ ERREUR ! C'était : ${currentEmotionSituation.emoji} ${currentEmotionSituation.correct.toUpperCase()}`;
        ...
        function endEmotionGame(won) {
            ...
            if (won) {
                robot.innerHTML = '🏆';
                feedback.innerHTML = `🎉 PARFAIT ! Score final: ${emotionScore} points !`;
                feedback.style.color = '#00f5ff';
                document.getElementById('currentSituation').textContent = 'Tu as terminé toutes les situations !';
            } else {
                robot.innerHTML = '🎮';
                feedback.innerHTML = `Partie terminée ! Score: ${emotionScore} points`;
        ...
        const notes = {
            'Do': {freq: 261.63, emoji: '🎤', id: 'part-head'},
            'Mi': {freq: 329.63, emoji: '📦', id: 'part-body'},
            'Sol': {freq: 392.00, emoji: '🦾', id: 'part-arm'},
            'La': {freq: 440.00, emoji: '🦿', id: 'part-leg'}
        };
        ...
        function nextLevel() {
            ...
            document.getElementById('musicStatus').textContent = '🎵 Écoute bien la séquence...';
        ...
        async function playSequence() {
            ...
            document.getElementById('musicStatus').textContent = '🎮 À toi de jouer ! Reproduis la séquence';
        ...
        function levelComplete() {
            ...
            document.getElementById('musicStatus').textContent = '✅ PARFAIT ! Niveau suivant...';
            document.getElementById('musicStatus').style.color = '#00ff88';
        ...
        function gameOver() {
            ...
            document.getElementById('musicStatus').innerHTML = `❌ ERREUR ! Tu es arrivé au niveau ${musicLevel}<br>Séquence de ${musicSequence.length} notes !`;
        ...
        function replaySequence() {
            ...
            playerSequence = [];
            document.getElementById('musicStatus').textContent = '🔊 Réécoute de la séquence...';
            document.getElementById('musicStatus').style.color = '#00f5ff';
        ...
        function checkMirror() {
            if (robot1Sequence.length === 0) {
                document.getElementById('mirrorResult').innerHTML = '⚠️ Programme ALPHA d\'abord !';
                document.getElementById('mirrorResult').style.color = '#ff00ff';
                return;
            }
            
            const mirrorMap = {'⬆️': '⬇️', '⬇️': '⬆️', '⬅️': '➡️', '➡️': '⬅️'};
            ...
            if (JSON.stringify(robot2Sequence) === JSON.stringify(correctMirror)) {
                document.getElementById('mirrorResult').innerHTML = '✅ SYNCHRONISATION PARFAITE !';
                document.getElementById('mirrorResult').style.color = '#00ff88';
            } else {
                document.getElementById('mirrorResult').innerHTML = '❌ ERREUR DE SYNCHRONISATION - Inverse chaque direction';
        ...
        const story = {
            start: {
                text: "🤖 MISSION ALPHA : Tu es un robot explorateur sur la planète Zeta-9. Une grotte mystérieuse se dresse devant toi, émettant une lueur étrange. Tes capteurs détectent une activité inhabituelle. Quelle est ta décision ?",
                choices: [
                    {text: "🔦 ACTIVER SCANNER COMPLET - Analyser la grotte en détail", next: 'scan', points: 150, speed: 'smart'},
                    {text: "🚀 PROPULSEUR BOOST - Survoler la grotte", next: 'jump', points: 100, speed: 'risky'},
                    {text: "📡 TRANSMISSION BASE - Demander des instructions", next: 'message', points: 120, speed: 'safe'}
                ]
            },
            scan: {
                text: "🔍 SCAN TERMINÉ : Tes capteurs révèlent des cristaux énergétiques de classe A ! Ces ressources sont extrêmement rares. Tu pénètres dans la grotte et découvres une chambre lumineuse remplie de formations cristallines. Protocole suivant ?",
                choices: [
                    {text: "💎 EXTRACTION MINIÈRE - Collecter les cristaux", next: 'collect', points: 200, item: '💎', speed: 'efficient'},
                    {text: "📸 DOCUMENTATION VISUELLE - Archives photos", next: 'photo', points: 180, item: '📸', speed: 'scientific'},
                    {text: "🔙 ABANDON MISSION - Explorer un autre secteur", next: 'start', points: -50, speed: 'cautious'}
                ]
            },
            jump: {
                text: "⚡ ALERTE ÉNERGIE : Le propulseur a consommé 70% de ta batterie ! Tu atterris en sécurité mais tes systèmes signalent un niveau critique. Une station de recharge solaire apparaît à proximité. Action immédiate ?",
                choices: [
                    {text: "☀️ RECHARGE TOTALE - Restauration complète (20 min)", next: 'recharge', points: 100, speed: 'patient'},
                    {text: "⚡ RECHARGE EXPRESS - Mode rapide (5 min)", next: 'quickcharge', points: 140, speed: 'efficient'},
                    {text: "🔋 MODE ÉCONOMIE - Continuer avec batterie actuelle", next: 'save', points: 160, item: '⚡', speed: 'bold'}
                ]
            },
            message: {
                text: "📡 RÉPONSE BASE CENTRALE : Signal d'urgence détecté ! Des formes de vie inconnues ont été repérées dans ton secteur. La base te demande d'investiguer avec précaution. Tes capteurs s'activent automatiquement. Procédure ?",
                choices: [
                    {text: "🔍 MODE PISTAGE - Suivre les signaux biologiques", next: 'signals', points: 170, speed: 'brave'},
                    {text: "🛡️ BOUCLIER DÉFENSIF - Activer protection maximale", next: 'defense', points: 130, item: '🛡️', speed: 'cautious'},
                    {text: "🏃 ÉVACUATION TACTIQUE - Changer de zone", next: 'start', points: -30, speed: 'safe'}
                ]
            },
            collect: {
                text: "✨ MISSION ACCOMPLIE ! Tu as collecté 47 cristaux énergétiques de haute qualité. La base centrale est impressionnée par ta découverte. Ces ressources permettront d'alimenter toute la colonie pendant des mois !",
                choices: [{text: "🔄 NOUVELLE MISSION", next: 'end', points: 300, final: true}]
            },
            photo: {
                text: "📸 DOCUMENTATION RÉUSSIE ! Tes captures haute définition révèlent des structures jamais observées. Les scientifiques de la base sont enthousiastes. Tu reçois la MÉDAILLE D'OR DE LA DÉCOUVERTE !",
                choices: [{text: "🔄 NOUVELLE MISSION", next: 'end', points: 250, final: true}]
            },
            recharge: {
                text: "🔋 SYSTÈMES À 100% ! Tous tes circuits sont optimisés. Tes capacités sont maintenant supérieures au niveau standard. Tu es prêt pour n'importe quelle mission !",
                choices: [{text: "🔄 CONTINUER", next: 'end', points: 150, final: true}]
            },
            quickcharge: {
                text: "⚡ RECHARGE EXPRESS TERMINÉE ! En explorant pendant la charge, tu découvres une cascade de photons bioluminescents, un phénomène extrêmement rare !",
                choices: [{text: "🔄 CONTINUER", next: 'end', points: 220, item: '🌟', final: true}]
            },
            save: {
                text: "💡 DÉCISION STRATÉGIQUE ! En économisant ton énergie, tu découvres un passage secret qui te mène directement à un dépôt de carburant abandonné. Efficacité optimale !",
                choices: [{text: "🔄 CONTINUER", next: 'end', points: 280, item: '🔋', final: true}]
            },
            signals: {
                text: "👽 RENCONTRE EXTRAORDINAIRE ! Tu découvres une colonie de robots bienveillants d'une civilisation ancienne. Ils partagent leurs connaissances technologiques avec toi !",
                choices: [{text: "🔄 CONTINUER", next: 'end', points: 350, item: '📜', final: true}]
            },
            defense: {
                text: "🛡️ FAUSSE ALERTE ! Les 'formes de vie' étaient en réalité des papillons énergétiques, des créatures magnifiques et inoffensives qui dansent dans l'air en émettant de la lumière !",
                choices: [{text: "🔄 CONTINUER", next: 'end', points: 200, final: true}]
            }
        };
        ...
        function showPointGain(points, timeBonus) {
            ...
            feedback.textContent = (points > 0 ? '+' : '') + points + (timeBonus > 0 ? ' (⚡+' + timeBonus + ')' : '');
        ...
        function endStory() {
            ...
            if (finalScore >= 800) {
                rank = 'LÉGENDE ROBOTIQUE';
                emoji = '🏆';
            } else if (finalScore >= 600) {
                rank = 'EXPERT EN MISSION';
                emoji = '⭐';
            } else if (finalScore >= 400) {
                rank = 'EXPLORATEUR COMPÉTENT';
                emoji = '🎖️';
            ...
            document.getElementById('storyText').innerHTML = `
                ...
                📊 SCORE FINAL : ${finalScore} points<br>
                ⏱️ TEMPS : ${finalTime} secondes<br>
                💎 OBJETS COLLECTÉS : ${storyItems.length}<br>
                ${itemBonus > 0 ? '🎁 BONUS OBJETS : +' + itemBonus + ' points<br>' : ''}<br>
                ${finalScore >= 600 ? '🎉 FÉLICITATIONS ! Performance exceptionnelle !' : 'Rejoue pour améliorer ton score !'}
            `;
            ...
            replayBtn.textContent = '🔄 REJOUER POUR BATTRE TON SCORE';
        ...
        const bugTypes = {
            spin: {name: 'Rotation Infinie', animation: 'spin3d 2s linear infinite', description: '🌀 Le robot tourne sans arrêt !'},
            bounce: {name: 'Mode Rebond', animation: 'bounce-crazy 0.6s infinite', description: '⚡ Le robot rebondit partout !'},
            grow: {name: 'Oscillation Taille', animation: 'grow-pulse 1.5s infinite', description: '📈 Le robot change de taille !'},
            shake: {name: 'Vibration Intense', animation: 'shake-intense 0.4s infinite', description: '💥 Le robot vibre intensément !'},
            rainbow: {name: 'Spectre Chromatique', animation: 'rainbow-glow 2s infinite', description: '🌈 Le robot change de couleur !'},
            flip: {name: 'Flip 3D', animation: 'flip-3d 1.5s infinite', description: '🔄 Le robot se retourne sans cesse !'}
        };
        ...
        function nextBug() {
            ...
            // Update status
            let statusText = `⚠️ <strong>ALERTE NIVEAU ${repairLevel}</strong><br>`;
            if (numBugs === 1) {
                statusText += bugTypes[currentBugs[0]].description;
            } else {
                statusText += `<strong>${numBugs} BUGS DÉTECTÉS !</strong><br>`;
                currentBugs.forEach(bug => {
                    statusText += `${bugTypes[bug].description}<br>`;
                });
                statusText += `<br>🎯 Répare-les TOUS pour continuer !`;
            }
        ...
        function attemptFix(bugType) {
            ...
            if (currentBugs.includes(bugType)) {
                ...
                if (currentBugs.length === 0) {
                    ...
                    // Some bugs remain
                    document.getElementById('bugStatus').innerHTML = `✅ <strong>1 BUG RÉPARÉ !</strong><br>Il reste ${currentBugs.length} bug(s) à réparer !`;
        ...
        function successfulRepair() {
            ...
            document.getElementById('bugStatus').innerHTML = `✅ <strong>NIVEAU ${repairLevel} TERMINÉ !</strong><br>+${totalPoints} points<br>(⚡ Bonus temps: +${timeBonus} | 📊 Bonus niveau: +${levelBonus})`;
            document.getElementById('bugStatus').style.color = '#00ff88';
        ...
        function wrongRepair(wrongBugType) {
            ...
            document.getElementById('bugStatus').innerHTML = `❌ <strong>MAUVAIS DIAGNOSTIC !</strong><br>"${bugTypes[wrongBugType].name}" n'est pas actif !<br>Les bugs continuent... -50 points`;
            document.getElementById('bugStatus').style.color = '#ff0055';
        ...
        function failedRepair() {
            ...
            document.getElementById('bugStatus').innerHTML = `⏰ <strong>TEMPS ÉCOULÉ !</strong><br>C'était : ${bugsText}<br><br>🎯 Score final: ${repairScore} points<br>📊 Niveau atteint: ${repairLevel}/6`;
            document.getElementById('bugStatus').style.color = '#ff0055';
        ...
        function endRepairGame() {
            ...
            if (repairScore >= 2500) {
                rank = 'TECHNICIEN LÉGENDAIRE';
                emoji = '🏆';
            } else if (repairScore >= 2000) {
                rank = 'EXPERT EN RÉPARATION';
                emoji = '⭐';
            } else if (repairScore >= 1500) {
                rank = 'RÉPARATEUR COMPÉTENT';
                emoji = '🎖️';
            } else if (repairScore >= 1000) {
                rank = 'APPRENTI TECHNICIEN';
                emoji = '🎯';
            } else {
                rank = 'DÉBUTANT COURAGEUX';
                emoji = '💪';
            }
            
            document.getElementById('bugStatus').innerHTML = `
                ${emoji} <strong>${rank}</strong> ${emoji}<br><br>
                🎉 <strong>TOUS LES NIVEAUX TERMINÉS !</strong><br><br>
                📊 SCORE FINAL : ${repairScore} points<br>
                ✅ 6 NIVEAUX COMPLÉTÉS<br>
                🔧 Tous les bugs réparés !<br><br>
                ${repairScore >= 2000 ? '🌟 PERFORMANCE EXCEPTIONNELLE !' : 'Rejoue pour améliorer ton score !'}
            `;
            ...
            document.getElementById('repairStartBtn').style.display = 'block';
            document.getElementById('repairStartBtn').textContent = '🔄 REJOUER POUR BATTRE TON SCORE';
        }
        ...
        function showLevelUp() {
            ...
            let levelText = `⬆️ NIVEAU ${repairLevel} !`;
            if (repairLevel === 4) levelText += '<br><span style="font-size: 0.5em;">2 BUGS SIMULTANÉS !</span>';
